function navbarc(p1,p2,p3,p4){
    document.getElementById("navbarcid").innerHTML = `<nav id="navmina">
    <div class="container mx-auto flex justify-between items-center p-8 py-6">
      <h1 class="text-lg hover:text-yellow-800 font-semibold">
        <a href="./">Alma Remodeling</a>
      </h1>
      <div class="hidden md:flex gap-8 xl:gap-16">
      <ul class="gap-8 xl:gap-16 flex justify-between items-center">
      ...
      <a href="./vr.html" class="border border-white p-2 px-4 rounded-md bg-yellow-700 text-white hover:bg-yellow-900 shadow cursor-pointer">
      vr room
      </a>
      </div>
      <div class="md:hidden flex items-center gap-8">
        <a href="./vr.html" class="border p-2 px-4 rounded-md border-yellow-700 text-yellow-700 hover:text-white hover:bg-yellow-700 shadow cursor-pointer">
              vr room
        </a>
        <div onclick="navtoggle()" class=" cursor-pointer">
  ...
  .then(data => {
    ...
    dropdown.classList = "md:shadow-2xl";
    const li = document.createElement("li");
      li.innerHTML = `<a href="./prodacts.html" class="cursor-pointer" >all prodact</a>`;
...
function navtoggle2(){
    document.getElementById("prodact-dropdown2").classList.toggle("hidden");
        document.getElementById("navmina").classList.toggle("md:shadow-2xl");
};
